...
public class GalagaState extends State {
    ...
    public void render(Graphics g) {
        ...
        if (Mode.equals("Stage")) {
            ...
            g.drawString("Score:",handler.getWidth()/2-100,handler.getHeight()/16);
            g.setColor(Color.WHITE);
            g.drawString(String.valueOf(handler.getScoreManager().getGalagaCurrentScore()),handler.getWidth()/2+50,handler.getHeight()/16);
