...
public class Images {
    ...
    public Images() {
        ...
        pacmanDots = new BufferedImage[6];
        ...
        try {
            ...
            galagaEnemyShip[0] = galagaSpriteSheet.crop(162,249,11,12);
            galagaEnemyShip[1] = galagaSpriteSheet.crop(115,250,12,12);
            ...
            ghost[0] = pacmanSpriteSheet.crop(456,64,16,16); //Red ghost
            ghost[1] = pacmanSpriteSheet.crop(553,81,14,14); //Pink ghost
            ghost[2] = pacmanSpriteSheet.crop(553,97,14,14); //Light blue ghost
            ghost[3] = pacmanSpriteSheet.crop(553,113,14,14); //Orange ghost
            ghost2[0] = pacmanSpriteSheet.crop(585,64,14,14);
            ghost2[1] = pacmanSpriteSheet.crop(553,113,14,14);
            pacmanDots[0] = pacmanSpriteSheet.crop(643,18,16,16);
            pacmanDots[1] = pacmanSpriteSheet.crop(623,18,16,16); 
            pacmanDots[2] = ImageIO.read(getClass().getResourceAsStream("/UI/Misc/blackdot.png"));
            pacmanDots[3] = pacmanSpriteSheet.crop(490,50,12,12); //Fruit 1
            pacmanDots[4] = pacmanSpriteSheet.crop(506,50,11,12); //Fruit 2
            pacmanDots[5] = pacmanSpriteSheet.crop(555,49,11,14); //Fruit 3
            ...
            GameOver = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/UI/SpriteSheets/PacMan/gameoverSheet.png")));
            gameOver = GameOver.crop(4, 6, 256, 226);
